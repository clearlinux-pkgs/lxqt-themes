...
Source0  : https://github.com/lxqt/lxqt-themes/releases/download/1.2.0/lxqt-themes-1.2.0.tar.xz
Source1  : https://github.com/lxqt/lxqt-themes/releases/download/1.2.0/lxqt-themes-1.2.0.tar.xz.asc
...
%prep
%setup -q -n lxqt-themes-1.2.0
cd %{_builddir}/lxqt-themes-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667838216
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lxqt-themes-%{version}/COPYING %{buildroot}/usr/share/package-licenses/lxqt-themes/7fab4cd4eb7f499d60fe183607f046484acd6e2d || :
pushd clr-build
%make_install
popd
